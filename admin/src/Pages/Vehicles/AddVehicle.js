...
import ManageVehicleDetailsComponent from "./ManageVehicleDetailsComponent";
  ...
  const addColorAction = () => {
    setVehicleColors([
      ...vehicleColors,
      {
        imageType: imageType,
        name: colors,
        imagePreview: imageName?.fileName,
      },
    ]);
    setImageName("");
    setColors("");
      ...
      <div className="d-flex flex-column gap-4">
        <div className="d-flex gap-2">
          <div className="section" style={{ width: "250px" }}>
            <ImageUploader
              onChange={(value) => setVehicleImage(value?.fileName)}
              image={vehicleImage}
            />
          </div>
        ...
        <div className="section">
          ...
          <div className=" mt-4 mb-2">
            ...
            <div className="add_vehicle_container">
              <FormControl>
                <FormControl className="text-secondary">Status</FormControl>
                <select
                  value={status}
                  className="form-select"
