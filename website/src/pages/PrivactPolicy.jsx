...
function PrivactPolicy() {
  return (
    <div className="container mt-5">
      ...
      <h5 className="text-secondary">Last updated: January 17, 2024</h5>
      <p className="text" >
      ...
      <p className="text" >
        <ul>
          ...
          <li>
            <strong> Application</strong> refers to Power Motoring, the software
            program provided by the Company.
          </li>
          <li>
            <strong>Company </strong>(referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Agreement) refers to Power Motoring.
          </li>
          <li>
          ...
          <li>
            <strong> Website</strong> refers to Power Motoring, accessible
            from https://powermotoring.com
          </li>
          <li>
      ...
      <p className="text" >Usage Data is collected automatically when using the Service.</p>
      <p className="text" >
      ...
      <p className="text" >
        ...
        <ul>
          <li>
            ...
            <p className="text" ></p>
            <p className="text" >Type: Session Cookies</p> <p className="text" >Administered by: Us</p>
            <p className="text" >
          ...
          <li>
            ...
            <p className="text" ></p>
            <p className="text" >Type: Persistent Cookies</p> <p className="text" >Administered by: Us</p>
            <p className="text" >
      ...
      <p className="text" >We may share Your personal information in the following situations:</p>
      <p className="text" >
        <ul>
          <li>
      ...
      <p className="text" >
        ...
        third party&#39;s site. We strongly advise You to review
      ...
      <p className="text" >
        <ul>
          <li>By email: admin@powermotoring.com</li>
        </ul>
      </p>
    </div>
  );
