...
function TermsConditions() {
  return (
    <div className="container mt-5">
      ...
      <h5 className="text-secondary">Last updated August 30, 2023</h5>
      <h4 className="mt-4">AGREEMENT TO OUR LEGAL TERMS</h4>
      <p className="text">
        This App Power Motoring (&#39;Company&#39;, &#39;we&#39;, &#39;us&#39;,
        or &#39;our&#39;), is built by Power Motoring(Nisamudheen ALI) ,
        in India at ,Muvattupuzha, Kerala 686673.
      </p>
      <p className="text">
        We operate the mobile application Power Motoring (the &#39;App&#39;), as
        well as any other related products and services that refer or link to
        these legal terms (the &#39;Legal Terms&#39;) (collectively,
        the &#39;Services&#39;).
      </p>
      <p className="text">
        This app Power Motoring contains the details of cars which are sold in
        India. Details such as Specification and Colours are shown in the app
        model wise and features are arranged variant wise so that users can
        easily understand . Developer can add or remove any manufacturer or any
        product at any time and that belongs to sole discretion of developer We
        have added new subscription plan for removing the ads , those who
        don&#39;t want to see the ads can opt for that .Also as of now we have a
        free usage plan with ads, developer may or may not remove this option in
        future, it is at sole discretion of developer. After making payment for
        subscription, refund will not be provided . Working of app may be
        affected when the server is down or in case of any upgradation or
        transfer is happening in the server. Only 1 device will be allowed per
        subscription. There are chances for getting some changes(very limited)
        in the information provided variant wise/colours/spec etc.., in this
        situation we are not responsible for the losses if any happens to the
        user and you can inform about the same to us using feedback session.
        Images in this app is taken from websites of respective products , it
        may look little different in colour than in real life it is for
        representation only.
      </p>
      <p className="text">
        You can contact us by email
        at admin@powermotoring.com/powermotoringapp@gmail.com
      </p>
      <p className="text">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (&#39;you&#39;),
        and Power Motoring , concerning your access to and use of the Services.
      ...
      <p className="text">
        ...
        Services you are using. Changes to Legal Terms will become effective one
        (1) days after the notice is given, except if the changes apply to new
        functionality, bug fixes, and security updates, in which case the
      ...
      <p className="text">
        and logos contained therein (the &#39;Marks&#39;). Our Content and Marks
      ...
      <p className="text">
        <ul>
          <li className="text">Access the Services; </li>
          <li className="text">
      ...
      <p className="text">solely for your internal business purpose.</p>
      <p className="text">
      ...
      <p className="text">
        ...
        address your request to: admin@powermotoring.com. If we ever grant you
      ...
      <p className="text">We accept the following forms of payment:</p>
      <p className="text">-  UPI, Cards</p>
      <p className="text">
        ...
        change prices at any time. All payments shall be in Indian Rupee.
      </p>
      <p className="text">
      ...
      <p className="text">All sales are final and no refund will be issued.</p>
      <p>
      ...
      <p className="text">As a user of the Services, you agree not to:</p>
      <p className="text">
        <ul>
          <li>
          ...
          <li> Only one device is allowed per subscription</li>
        </ul>
      </p>
      <p>
      ...
      <p className="text">
        ...
        of, or incorporate into other works, such Contributions, and grant
        and authorise sublicences of the foregoing. The use and distribution may
      ...
      <p className="text">
        ...
        Apple Store or Google Play (each an &#39;App Distributor&#39;) to access
        the Services: (1) the licence granted to you for our App is limited to a
        ...
        in this mobile application licence contained in these Legal Terms, and
        ...
        mobile application licence contained in these Legal Terms against you as
      ...
      <p className="text">
        ...
        account with the Third-Party Account. Depending on
        the Third-Party Accounts you choose and subject to the privacy settings
        ...
        on and through your account on the Services. Please note that if
        a Third- Party Account or associated service becomes unavailable or our
      ...
      <p className="text">
        ...
        information in certain areas of the Services, such as interstitial
      ...
      <p className="text">
        ...
        Policy: 
        <a href="http://powermotoring.com/Privacy_Policy">
          http://powermotoring.com/Privacy_Policy
        </a>
        ...
        in India, then through your continued use of the Services, you are
        transferring your data to India, and you expressly consent to have your
        data transferred to and processed in India. Further, we do not knowingly
      ...
      <p className="text">
        ...
        of India. Power Motoring and yourself irrevocably consent that the
      ...
      <p className="text">
        ...
        be one (1). The seat, or legal place, or arbitration shall
        be Muvattupuzha , India. The language of the proceedings shall
      ...
      <p className="text">
        ...
        or unauthorised use; and (c) any claim for injunctive relief. If this
      ...
      <p>
        <br /> Power Motoring,
        <br /> Muvattupuzha Kerala 686673,
        <br /> India,
        <br /> admin@powermotoring.com
      </p>
    </div>
  );
}
